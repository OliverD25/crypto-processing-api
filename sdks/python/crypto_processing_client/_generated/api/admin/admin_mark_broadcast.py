...
from ...models.mark_broadcast_request import MarkBroadcastRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/admin/withdrawals/{withdrawal_id}/mark-broadcast".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        withdrawal_id (UUID):
        body (MarkBroadcastRequest): The operator reporting what they sent.
