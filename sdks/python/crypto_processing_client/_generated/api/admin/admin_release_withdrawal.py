...
from ...models.release_withdrawal_request import ReleaseWithdrawalRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/admin/withdrawals/{withdrawal_id}/release".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        withdrawal_id (UUID):
        body (ReleaseWithdrawalRequest): A release after submission is an assertion about the
            chain.
